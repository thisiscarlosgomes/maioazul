...
export default function LayoutShell({ children }: { children: ReactNode }) {
    ...
    () => ({
      en: {
        ...
        exploreItems: [
          ...
          "Save favorites to return later.",
          "Connect with locals — feel the morabeza.",
        ],
        quoteBody:
          "“Go slowly. The island will tell you what you need to hear.”",
      },
      pt: {
        nowPlaying: "A tocar",
        pause: "Pausar",
        ...
        exploreItems: [
          ...
          "Guarde favoritos para voltar depois.",
          "Conecte-se com os locais — sinta a morabeza.",
        ],
        quoteBody:
          "“Vá devagar. A ilha diz-lhe o que precisa ouvir.”",
      },
    }),
    []
  );
  ...
  const handleIntroNext = () => {
    setIntroStep((step) => Math.min(step + 1, 3));
  };
      ...
      >
        <Drawer.Portal>
          <Drawer.Overlay className="fixed inset-0 z-[70] bg-black/40 backdrop-blur-sm" />
            <Drawer.Content className="fixed inset-x-0 bottom-0 z-[80] min-h-[60svh] rounded-t-3xl border border-border bg-background p-5 pb-10 shadow-xl flex flex-col">
              ...
              {introStep === 0 ? (
                ...
                <div className={`mt-4 space-y-3 ${introStep === 3 ? "text-center" : ""}`}>
                  <div className={`text-lg font-semibold text-foreground ${introStep === 3 ? "text-center" : ""}`}>
                    {introStep === 1
