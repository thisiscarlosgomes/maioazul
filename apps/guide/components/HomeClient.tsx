...
const copy = {
  en: {
    ...
    description:
      "The island of Maio has always moved at its own pace, shaped by the close relationship between people, land, and time. Visit Maio grows from this essence: giving visibility to this rhythm, supporting local initiatives, and affirming a future aligned with the island’s identity — without compromising what makes it distinct.",
    partners: "Partners",
  ...
  pt: {
    ...
    description:
      "A Ilha do Maio sempre viveu no seu próprio ritmo, moldado pela autenticidade humana, o território e a sua história. A Visit Maio nasce dessa essência: dar visibilidade a esse ritmo, apoiar iniciativas locais e afirmar um futuro alinhado com a identidade da ilha, sem a descaracterizar.",
    partners: "Parceiros",
      ...
      <div className="relative z-30 h-full flex flex-col justify-between">
        ...
        <header className="grid grid-cols-3 items-center pt-10 pb-6 text-white">
          ...
          <div className="flex justify-center">
            <img src="/logo.png" alt="Visit Maio" className="h-4 w-auto" />
          </div>
