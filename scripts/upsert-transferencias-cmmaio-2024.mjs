...
const ANNUAL_2024_VALUE = 125537932;
...
async function run() {
    ...
    { key: KEY },
    {
      $set: {
        ...
        meta: {
          ...
          note: "2024 atualizado com fecho anual consolidado (MES=12).",
        },
        updatedAt: new Date(),
      },
      $setOnInsert: {
  ...
  await client.close();
  console.log(
    `Transferências atualizadas: ${KEY} (MES=12, VALOR_PAGO=${ANNUAL_2024_VALUE})`
  );
}
